...
public class EmployeeMovieShowController {
	@FXML
    ...
    private void switchToMovieDetailScene(MouseEvent event, String posterPath, String title,String description,String startDate,String endDate) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("EmployeeMovieDetail.fxml"));
        Parent root = loader.load();
        
        EmployeeMovieDetailController detailController = loader.getController();
